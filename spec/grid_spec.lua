...
describe("Grid", function ()
    ...
    describe("Initialize", function ()
        it("with gefault size", function ()
            assert.has_error(function () Grid() end, "Grid: size_x and size_y must be a number values equal or greater than 1")
        end)
    ...
    describe("Get cell", function ()
        ...
        it("get invalid cell", function ()
            assert.has_error(function ()test_grid:get_cell("a", "b") end, "Grid: try to get cell by invalid index [ a : b]")
        end)
    end)
